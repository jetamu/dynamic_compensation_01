...
public:
    ParameterEstimatorNode() : Node("parameter_estimator_node") {
        ...
        this->declare_parameter<double>("gamma_inv_1", 2.0);
        this->declare_parameter<double>("gamma_inv_2", 1.5);
        this->declare_parameter<double>("gamma_inv_3", 0.5);
        this->declare_parameter<double>("gamma_inv_4", 0.3);
        ...
        this->declare_parameter<double>("Gamma_1", 0.0042);
        this->declare_parameter<double>("Gamma_2", 0.0016);
        ...
        this->declare_parameter<double>("Ku1", 0.6);
        ...
        this->declare_parameter<double>("epsilon_u", 0.018);
        this->declare_parameter<double>("epsilon_w", 0.0882);
